...
const newEntries = [
  ...
  { country: 'United States', entry: { id: 'orthodox-union', name: 'Orthodox Union (OU)', type: 'Jewish Organization', category: 'Religion & Synagogues', founded: 1898, description: 'The largest Orthodox Jewish umbrella organization in the United States, serving nearly 1,000 congregations. Best known for its OU kosher certification, one of the world\'s most recognized kosher symbols, certifying over 1 million products. Also runs NCSY youth programs and advocacy initiatives.', 
