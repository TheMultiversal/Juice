...
addEntry(us, { name: "Orthodox Union (OU)", type: "Jewish organization", description: "Largest Orthodox Jewish umbrella organization in the US, also the world's largest kosher certification agency.", website: "https://www.ou.org/", individuals: [{ name: "Rabbi Moshe Hauer", role: "Executive Vice President", bio: "Executive VP of the Orthodox Union." }] });
addEntry(us, { name: "United Synagogue of Conservative Judaism", type: "Jewish organization", description: "Association of 600 Conservative congregations across North America.", website: "https://www.uscj.org/", individuals: [] });
addEntry(us, { name: "Union for Reform Judaism (URJ)", type: "Jewish organization", description: "Represents nearly 900 Reform congregations across North America.", website: "https://urj.org/", individuals: [{ name: "Rabbi Rick Jacobs", role: "President", bio: "President of the Union for Reform Judaism." }] });
addEntry(us, { name: "Reconstructing Judaism", type: "Jewish organization", description: "Central organization of the Reconstructionist movement.", website: "https://www.reconstructingjudaism.org/", individuals: [{ name: "Rabbi Deborah Waxman", role: "President", bio: "First woman rabbi and first lesbian to lead a Jewish congregational union." }] });
addEntry(us, { name: "Agudath Israel of America", type: "Jewish organization", description: "Haredi Orthodox Jewish advocacy organization founded in 1922.", website: "https://agudah.org/", individuals: [{ name: "Rabbi Chaim Dovid Zwiebel", role: "Executive Vice President", bio: "Executive VP of Agudath Israel." }] });
